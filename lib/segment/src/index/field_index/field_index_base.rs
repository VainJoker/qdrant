...
use crate::types::{
    DateTimePayloadType, FieldCondition, FloatPayloadType, IntPayloadType, Match, MatchFuzzy, MatchPhrase, MatchText, PayloadKeyType, RangeInterface, UuidIntType, UuidPayloadType
};
    ...
    pub fn special_check_condition(
        ...
        match self {
            ...
            FieldIndex::FullTextIndex(full_text_index) => match &condition.r#match {
                ...
                Some(Match::Fuzzy(MatchFuzzy { fuzzy })) => {
                    let query = full_text_index.parse_fuzzy_query(fuzzy, hw_counter)?;
                    Some(
