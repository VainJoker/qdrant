...
use crate::types::{FieldCondition, Match, MatchFuzzy, MatchPhrase, MatchText, PayloadKeyType};
...
impl FullTextIndex {
    ...
    pub(super) fn get_tokenizer(&self) -> &Tokenizer {
        match self {
    ...
    /// Parses a [`MatchFuzzy`] condition into a [`ParsedQuery`].
    ...
    pub fn check_payload_match<const IS_PHRASE: bool>(
        ...
        FullTextIndex::get_values(payload_value)
            ...
            .any(|value| match &query {
                ...
                ParsedQuery::FuzzyAllTokens(_)
                | ParsedQuery::FuzzyAnyTokens(_)
                | ParsedQuery::FuzzyPhrase(_) => {
                    unreachable!("Fuzzy queries should not be generated by check_payload_match")
                }
            })
    }
